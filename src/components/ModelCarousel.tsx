  ...
  const models = [
    {
      ...
      name: "Modelo 1",
      isFree: true // Liberado gratuitamente
    },
    {
      id: 2,
    ...
    },
    {
      ...
      image: "https://i.postimg.cc/8z2Zfyjt/bab136ac-395d-455f-8748-715403cabae6.jpg",
      name: "Modelo 11",
      isFree: false // Requer assinatura
    },
    {
      id: 12,
      image: "https://i.postimg.cc/0NSHVTLT/39c9af01-465c-460d-8b98-abf8cda14bc1.jpg",
            ...
            >
              <div className="relative group cursor-pointer transform transition-all duration-300 hover:scale-105">
                <div className="relative overflow-hidden rounded-lg">
                  ...
                  {/* Overlay baseado em se é grátis ou não */}
                  <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center opacity-100 transition-opacity duration-300">
                    ...
                    {model.isFree ? (
                      <>
                        <div className="bg-green-600 text-white px-2 py-1 rounded-full text-xs font-bold mb-2">
                          GRÁTIS
                        </div>
                        <p className="text-white text-sm font-semibold mb-4 text-center px-4">
                          {model.name} - Conteúdo Liberado
                        </p>
                        <button
                          onClick={onVideoClick}
                          className="bg-gradient-to-r from-green-600 to-green-500 hover:from-green-500 hover:to-green-400 text-white px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 transform hover:scale-105"
                        >
                          Assistir Grátis
                        </button>
                      </>
                ...
                <div className="mt-2 text-center">
                  ...
                  <p className="text-xs text-gray-400">
                    {model.isFree ? 'Conteúdo Gratuito' : 'Conteúdo VIP'}
                  </p>
                </div>
              </div>
            </div>
